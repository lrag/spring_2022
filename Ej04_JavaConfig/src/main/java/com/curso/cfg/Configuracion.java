...
public class Configuracion {
	...
	*/
	...
	PeliculaDao peliculaDao() {
		...
		//Si no la tenemos se creará un nuevo DS cada vez que se invoque
	...
	DirectorDao directorDao() {
		System.out.println("Configuracion.directorDao()");
		DirectorDao directorDao = new DirectorDao();
		DataSource ds = dataSource();
		directorDao.setDataSource(ds);
		return directorDao;
	}
	...
	*/
	...
	Logger loggerError() {
		Logger logger = new Logger();
		logger.setNombreFichero("logs/logError.txt");
		return logger;	
	}		
