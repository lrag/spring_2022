...
//Estereotipos
//@Service   : Una clase con l�gica de negocio
...
@Repository
@Scope("singleton") //Esto es impl�cito
public class PeliculaDao {

	@Autowired
	//Por defecto es por tipo
	//Si hay m�s de un candidato por tipo prueba por nombre utilizando para ello el nombre del atributo
	//Si queremos la inyeccion por nombre a�adimos
