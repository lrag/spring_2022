...
public class Pruebas {
	...
	public static void main(String[] args) {
		...
		/*
		System.out.println("==================================================");
		Pelicula p = new Pelicula(1111,"Pelicula 2","D1","G1",111);
		try {
			gp.insertar(p);
		} catch (Exception e) {
		...
		*/
		...
		peliculas.add(new Pelicula(2222,null,"D2","G2",222));
		peliculas.add(new Pelicula(3333,"T3","D3","G3",333));
		peliculas.add(new Pelicula(4444,null,"D4","G4",444));
		peliculas.add(new Pelicula(5555,"T5","D5","G5",555));
		...
		for(Pelicula pAux: peliculas2){
			System.out.println(pAux.getTitulo());
		}		
